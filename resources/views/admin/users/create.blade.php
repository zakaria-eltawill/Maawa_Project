...
<div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-purple-100 p-8">
    <h2 class="text-3xl font-bold text-gray-900 mb-8">Create New User</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select 
                    name="role"
                    required
                    class="w-full px-5 py-3 border-2 border-purple-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition @error('role') border-red-500 @enderror">
                ...
                @enderror
                @if(!$canCreateAdmin)
                    <p class="mt-1 text-xs text-gray-500">Only super admin can create admin users</p>
                @endif
            </div>
